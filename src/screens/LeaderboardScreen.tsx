...
const LeaderboardScreen = () => {
    ...
    // Current user mock (Alex Johnson from constants)
    ...
    return (
        <div className="min-h-screen bg-[#1a1d2e] font-sans pb-32">
            ...
            <main className="max-w-xl mx-auto px-4 py-8 space-y-8">
                ...
                {/* Podium Layout for Top 3 (Only show if search is empty or if filter has enough results) */}
                ...
                <div className="space-y-1">
                    <div className="flex items-center justify-between px-4 mb-4">
                        ...
                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em]">{filteredData.length} Players</span>
                    </div>
                        ...
                        <AnimatePresence mode="popLayout">
                            ...
                            {filteredData.length === 0 && (
                                ...
                                >
                                    ...
                                    <p className="text-slate-500 font-bold">No champions found with &quot;{searchQuery}&quot;</p>
                                </motion.div>
                            )}
                        </AnimatePresence>
                    </div>
...
const PodiumItem = ({ user, rank, height, color, glow, animationDelay }: PodiumItemProps) => {
    return (
        <motion.div
        ...
        >
            ...
            <div className={cn(
                ...
                <div className="flex flex-col items-center">
                    ...
                    <span className="text-[10px] font-black text-slate-300 uppercase truncate w-full text-center px-2">{user.name.split(' ')[0]}</span>
                </div>

                <div className="flex flex-col items-center">
                    <span className="text-white font-black text-xs italic">{user.points.toLocaleString()}</span>
